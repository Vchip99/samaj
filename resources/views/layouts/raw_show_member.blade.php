        ...
        <div class="col-md-10 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading" style="height: 55px;">
                    <a href="{{ url('members')}}" class="btn btn-primary" style="float: right;margin-left: 5px;margin-top: -21px;">Back </a>
                </div>
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <input id="f_name" type="text" class="form-control" name="f_name" value="{{ (!empty($member->id))?$member->f_name:old('f_name') }}" placeholder="first name" readonly>
                        </div>
                        <div class="col-md-3">
                            <input id="m_name" type="text" class="form-control" name="m_name" value="{{ (!empty($member->id))?$member->m_name:old('m_name') }}" placeholder="middle name" readonly>
                        </div>
                        <div class="col-md-3">
                            <input id="l_name" type="text" class="form-control" name="l_name" value="{{ (!empty($member->id))?$member->l_name:old('l_name') }}" placeholder="last name" readonly>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="user_id" class="col-md-3 control-label">UserId </label>
                        <div class="col-md-6">
                            <input id="user_id" type="text" class="form-control" name="user_id" value="{{ (!empty($member->id))?$member->user_id:old('user_id') }}" placeholder="User id" readonly>
                        </div>
                    </div>
                    <div class="form-group">
